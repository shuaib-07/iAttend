package com.iattend.app.ui.modifiers
...
/**
 * Progressive edge blur + gradient scrim. Shader requires API 33+ (RuntimeShader);
 * below that only the gradient scrim renders.
 */
