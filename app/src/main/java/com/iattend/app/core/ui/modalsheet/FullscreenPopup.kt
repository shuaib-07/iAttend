...
/**
 * Adapted from T8RIN/ModalSheet (com.t8rin.modalsheet).
 *
 * Opens a popup with the given content. The popup is visible as long as it is part of the
 * composition hierarchy.
 *
 * Note: This is a highly reduced version of the official Popup composable with some changes:
 * * Fixes an issue with the action mode (copy-paste) menu, see
 *   https://issuetracker.google.com/issues/216662636 - Compose's own Popup can render the
 *   text-selection toolbar clipped behind sheet content; this hosts the sheet in its own
 *   decor-view-attached window instead, sidestepping that.
 * * Adds the view to the decor view of the window, instead of the window itself.
 * * Has no properties, since the popup is always laid out fullscreen.
 *
